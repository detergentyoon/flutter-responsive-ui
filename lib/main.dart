...
class DemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      designSize: const Size(360, 640), // 기준 디자인 사이즈 정의
      // ▼ ScreenUtillInit을 사용하는 경우 Buildcontext를 제공하거나 builder 함수 콜백에 값을 전달해야함
      builder: (BuildContext context, child) => MaterialApp( // 또는 builder: (_,child) => MaterialApp(
        title: 'Responsive UI Demo',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
          useMaterial3: true,
        ),
        home: const MainPage(title: 'Responsive UI Demo'),
    ...
    return TextField(
      decoration: InputDecoration(
        border: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: Colors.transparent, width: 0), // transparent: 투명
        ),
        // 활성화 테두리
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextButton(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min, // 전체 공간을 차지하는 대신 기본 액세스 공간을 최소로 줄임
                    children: [
